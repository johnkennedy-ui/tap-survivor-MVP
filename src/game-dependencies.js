...
(() => {
   ...
   */
  function createWorldSpatialRuntime({
    canvas,
    worldScale = 3,
    zoom = 1.25,
    random = Math.random,
  ...
  /**
   * @param {{ platformCapabilities?: StoragePlatformCapabilities | null }} [options]
   */
  function createStorageProvider({ platformCapabilities } = {}) {
    let defaultPlatformCapabilities = platformCapabilities || null;
    ...
    function createStorageAdapter(options) {
      ...
      /** @param {"getLocalStorage" | "getPreferences"} name */
