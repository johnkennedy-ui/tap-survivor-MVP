...
export const MODULE_NATIVE_SPRITES_PROOF_SLOTS = Object.freeze([
  "createSpriteSystem",
  "createSpriteSheetRenderer",
]);

export function createSpriteSystem({ ctx, spriteDefs }) {
  const sprites = {};
  const spriteConfigs = {};
...
export function createSpriteSheetRenderer({ ctx, spriteSheets = {} }) {
