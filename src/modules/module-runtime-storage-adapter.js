...
export function createModuleRuntimeStorageAdapter(options = {}) {
  ...
  const getItem = requireStorageFunction(storage.getItem, "options.storage.getItem");
  const removeItem = requireStorageFunction(storage.removeItem, "options.storage.removeItem");
  const setItem = requireStorageFunction(storage.setItem, "options.storage.setItem");
