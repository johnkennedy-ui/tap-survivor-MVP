...
- `src/weapon-projectiles.js`: pure projectile vector helpers used by weapon fire behavior.
...
- Weapon firing behavior: `src/weapon-fire.js`; projectile vector helpers live in `src/weapon-projectiles.js`, and targeting helpers live in `src/weapon-targeting.js`.
