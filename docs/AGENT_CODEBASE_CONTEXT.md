...
- `src/weapon-targeting.js`: pure weapon targeting helpers used by weapon fire behavior.
...
- Module bridge build: `scripts/build-module-bridges.mjs`; currently generates the shop-pricing classic bridge from `src/modules/shop-pricing.js`.
