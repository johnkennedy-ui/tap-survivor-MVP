...
- Module bridge build: `scripts/build-module-bridges.mjs`; currently generates balance, level-up-choices, math, shop-pricing, weapon-cooldowns, weapon-projectiles, and weapon-targeting classic bridges from `src/modules/`.
