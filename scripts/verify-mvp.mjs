...
check("relics have inventory icons", (content.relics || []).every((relic) => relic.iconPath) && game.includes("relic.iconPath") && shellUi.includes("relic.iconPath"));
