...
check("generated tower sprite set exists", content.assets?.sources?.some((source) => source.id === "generated_tower_sprites" && source.commercialUse === true && source.attributionRequired === false) && content.assets?.sprites?.player?.includes("player-tower-mage"));
