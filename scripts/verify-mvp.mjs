...
check("relic slots unlock by player level", save.includes("maxPlayerLevel") && runUpdate.includes("recordPlayerLevel") && relics.includes("maxEquippedRelics") && relics.includes("Math.floor(Math.max(0, save.maxPlayerLevel || 1) / 10)") && relics.includes("Math.min(5"));
