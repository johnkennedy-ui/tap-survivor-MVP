...
check("Laser weapon exists", game.includes("fireBeam") && contentText.includes("prism_beam"));
...
check("boss shockwave special exists", game.includes("updateBossSpecials") && rendering.includes("drawBossAttack") && game.includes('type: "shockwave"'));
