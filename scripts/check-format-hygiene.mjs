...
const LONG_LINE_ALLOWANCES = new Map([
  ...
  ["scripts/verify-mvp.mjs:239", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:253", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:258", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:262", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:267", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:288", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:311", "exact snippet assertion"],
]);
