...
const LONG_LINE_ALLOWANCES = new Map([
  ...
  ["scripts/verify-mvp.mjs:128", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:131", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:136", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:137", "exact snippet assertion"],
  ...
  ["scripts/verify-mvp.mjs:147", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:151", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:152", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:159", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:160", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:175", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:193", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:194", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:195", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:201", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:203", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:206", "exact snippet assertion"],
  ...
  ["scripts/verify-mvp.mjs:227", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:232", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:246", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:251", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:255", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:260", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:281", "exact snippet assertion"],
  ["scripts/verify-mvp.mjs:304", "exact snippet assertion"],
]);
